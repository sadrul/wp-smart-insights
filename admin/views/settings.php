...
if (isset($_POST['wpsi_save_settings']) && wp_verify_nonce($_POST['wpsi_settings_nonce'], 'wpsi_save_settings')) {
    ...
    echo '<div class="notice notice-success"><p>' . __('Settings saved successfully!', 'wp-smart-insights') . '</p></div>';
}
...
<div class="wrap">
    <h1><?php _e('Smart Insights Settings', 'wp-smart-insights'); ?></h1>
    ...
    <form method="post" action="">
        ...
        <div class="wpsi-settings-container">
            ...
            <div class="wpsi-settings-section">
                <h2><?php _e('General Settings', 'wp-smart-insights'); ?></h2>
                
                <table class="form-table">
                    <tr>
                        <th scope="row">
                            <label for="tracking_enabled"><?php _e('Enable Tracking', 'wp-smart-insights'); ?></label>
                        </th>
                        <td>
                            <input type="checkbox" id="tracking_enabled" name="tracking_enabled" value="1" <?php checked($tracking_enabled); ?> />
                            <p class="description"><?php _e('Enable user interaction tracking for heatmaps and user journeys.', 'wp-smart-insights'); ?></p>
                        </td>
                    </tr>
                    
                    <tr>
                        <th scope="row">
                            <label for="ai_api_key"><?php _e('AI API Key', 'wp-smart-insights'); ?></label>
                        </th>
                        <td>
                            <input type="password" id="ai_api_key" name="ai_api_key" value="<?php echo esc_attr($ai_api_key); ?>" class="regular-text" />
                            <p class="description"><?php _e('API key for enhanced AI-powered content analysis (optional).', 'wp-smart-insights'); ?></p>
                        </td>
                    </tr>
                </table>
            </div>
            ...
            <!-- Privacy Settings -->
            <div class="wpsi-settings-section">
                <h2><?php _e('Privacy & Compliance', 'wp-smart-insights'); ?></h2>
                
                <table class="form-table">
                    <tr>
                        <th scope="row">
                            <label for="privacy_compliant"><?php _e('GDPR Compliant', 'wp-smart-insights'); ?></label>
                        </th>
                        <td>
                            <input type="checkbox" id="privacy_compliant" name="privacy_compliant" value="1" <?php checked($privacy_compliant); ?> />
                            <p class="description"><?php _e('Enable GDPR compliance features including consent management.', 'wp-smart-insights'); ?></p>
                        </td>
                    </tr>
                    
                    <tr>
                        <th scope="row">
                            <label for="cookie_consent"><?php _e('Require Cookie Consent', 'wp-smart-insights'); ?></label>
                        </th>
                        <td>
                            <input type="checkbox" id="cookie_consent" name="cookie_consent" value="1" <?php checked($cookie_consent); ?> />
                            <p class="description"><?php _e('Show cookie consent banner before tracking user interactions.', 'wp-smart-insights'); ?></p>
                        </td>
                    </tr>
                    
                    <tr>
                        <th scope="row">
                            <label for="data_retention_days"><?php _e('Data Retention (Days)', 'wp-smart-insights'); ?></label>
                        </th>
                        <td>
                            ...
                            <p class="description"><?php _e('How long to keep user interaction data (1-3650 days).', 'wp-smart-insights'); ?></p>
                        </td>
                    </tr>
                    
                    <tr>
                        <th scope="row">
                            <label for="anonymize_ip"><?php _e('Anonymize IP Addresses', 'wp-smart-insights'); ?></label>
                        </th>
                        <td>
                            <input type="checkbox" id="anonymize_ip" name="anonymize_ip" value="1" <?php checked($anonymize_ip); ?> />
                            <p class="description"><?php _e('Remove last octet from IPv4 addresses for privacy.', 'wp-smart-insights'); ?></p>
                        </td>
                    </tr>
                    
                    <tr>
                        <th scope="row">
                            <label for="respect_dnt"><?php _e('Respect Do Not Track', 'wp-smart-insights'); ?></label>
                        </th>
                        <td>
                            <input type="checkbox" id="respect_dnt" name="respect_dnt" value="1" <?php checked($respect_dnt); ?> />
                            <p class="description"><?php _e('Stop tracking when users have Do Not Track enabled.', 'wp-smart-insights'); ?></p>
                        </td>
                    </tr>
                    
                    <tr>
                        <th scope="row">
                            <label for="privacy_policy_url"><?php _e('Privacy Policy URL', 'wp-smart-insights'); ?></label>
                        </th>
                        <td>
                            ...
                            <p class="description"><?php _e('URL to your privacy policy page (used in consent banner).', 'wp-smart-insights'); ?></p>
                        </td>
                    </tr>
                    
                    <tr>
                        <th scope="row">
                            <label for="data_processing_basis"><?php _e('Data Processing Basis', 'wp-smart-insights'); ?></label>
                        </th>
                        <td>
                            <select id="data_processing_basis" name="data_processing_basis">
                                <option value="legitimate_interest" <?php selected($data_processing_basis, 'legitimate_interest'); ?>><?php _e('Legitimate Interest', 'wp-smart-insights'); ?></option>
                                <option value="consent" <?php selected($data_processing_basis, 'consent'); ?>><?php _e('Consent', 'wp-smart-insights'); ?></option>
                            </select>
                            <p class="description"><?php _e('Legal basis for processing personal data under GDPR.', 'wp-smart-insights'); ?></p>
                        </td>
                    </tr>
                </table>
            </div>
        ...
        <p class="submit">
            <input type="submit" name="wpsi_save_settings" class="button-primary" value="<?php _e('Save Settings', 'wp-smart-insights'); ?>" />
        </p>
    </form>
</div>
